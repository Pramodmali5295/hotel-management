...
//   return (
//     <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-blue-100 via-blue-200 to-blue-400 font-poppins">
//       {/* Card */}
//       <div className="bg-white/80 backdrop-blur-md border border-white/40 shadow-2xl rounded-3xl p-8 sm:p-10 w-[90%] max-w-md transition-all duration-300">
//         {/* Header */}
//         <div className="flex flex-col items-center mb-8">
//           <div className="bg-blue-600 text-white p-3 rounded-full shadow-md mb-4">
...
//               className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-800 shadow-sm"
//               value={email}
...
//             type="submit"
//             disabled={loading}
//             className={`w-full py-3 rounded-xl font-semibold text-white flex justify-center items-center gap-2 transition-all duration-300 shadow-md ${
//               loading
