...
//             <form
//               onSubmit={editingKey ? updateCustomer : addCustomer}
//               className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 text-sm sm:text-base w-full"
//             >
//               {/* Full Name */}
...
//                     setCustomer({ ...customer, name: e.target.value })
//                   }
//                   className="border border-gray-300 px-4 py-3 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none w-full"
//                 />
//               </div>
...
//               {/* Date of Birth */}
//               <div className="flex flex-col w-full">
//                 <label htmlFor="dob" className="font-medium mb-1 text-gray-700">
//                   Date of Birth
//                 </label>
//                 <input
//                   id="dob"
...
//                     setCustomer({ ...customer, gender: e.target.value })
//                   }
//                   className="border border-gray-300 px-4 py-3 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none w-full bg-white"
//                 >
//                   <option value="">Select gender</option>
//                   <option>Male</option>
//                   <option>Female</option>
...
//                 <button
//                   type="submit"
//                   className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-md transition-transform transform hover:scale-105"
//                 >
//                   <Save size={18} /> {editingKey ? "Update" : "Add Customer"}
//                 </button>
//               </div>
...
//                   {/* Delete Button — outside textarea */}
//                   <div className="flex sm:mt-0 mt-2 justify-end sm:justify-start">
//                     <button
//                       onClick={() => handleDeleteMessage(key)}
//                       className="bg-red-500 hover:bg-red-600 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-1 text-xs sm:text-sm shadow-sm transition-all duration-150"
//                     >
//                       <Trash2 size={14} /> Delete
//                     </button>
//                   </div>
...
//                 className="inline-flex items-center gap-2 bg-indigo-600 text-white px-5 py-2 rounded-lg hover:bg-indigo-700 text-sm sm:text-base shadow-sm transition-all duration-150"
//               >
//                 <MessageSquarePlus className="w-4 h-4" /> Add Custom Message
//               </button>
//               <button
//                 onClick={handleSaveMessages}
//                 className="inline-flex items-center gap-2 bg-green-600 text-white px-5 py-2 rounded-lg hover:bg-green-700 text-sm sm:text-base shadow-sm transition-all duration-150"
//               >
      ...
      <main className="flex-1 max-w-6xl mx-auto py-8 px-4 sm:px-6">
        ...
        {activeSection === "list" && (
          <div className="bg-white rounded-2xl shadow-lg p-5 sm:p-8 border border-gray-100 overflow-x-auto">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-[750px] w-full border-collapse text-xs sm:text-sm">
                <thead className="bg-blue-100">
                  <tr>
                    <th className="p-2 sm:p-3 text-left border-b whitespace-nowrap w-[20%]">
                      Name
                    </th>
                    <th className="p-2 sm:p-3 text-left border-b whitespace-nowrap w-[20%]">
                      Mobile
                    ...
                    <th className="p-2 sm:p-3 text-left border-b whitespace-nowrap w-[15%]">
                      Gender
                    </th>
                    <th className="p-2 sm:p-3 text-center border-b whitespace-nowrap w-[25%]">
                      Actions
                    </th>
                  </tr>
                </thead>
                      ...
                      >
                        ...
                        <td className="p-2 sm:p-3 border-b text-center">
                          <div className="flex flex-col sm:flex-row justify-center items-center gap-2">
                            <button
                              onClick={() => editCustomerHandler(key, item)}
                              className="flex items-center justify-center gap-1 bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium transition-all shadow-sm w-full sm:w-auto"
                            >
                              <Edit3 size={14} /> Update
                            </button>
                            ...
                            <button
                              onClick={() => deleteCustomer(key)}
                              className="flex items-center justify-center gap-1 bg-red-600 hover:bg-red-700 text-white px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium transition-all shadow-sm w-full sm:w-auto"
                            >
                              <Trash2 size={14} /> Delete
                            </button>
                          </div>
