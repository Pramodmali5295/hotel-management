...
//           {/* Right Section: Username + Logout (Single Row on All Devices) */}
...
//             value={msg}
//             onChange={(e) => handleUpdateMessage(key, e.target.value)}
//             className="w-full border border-gray-300 px-4 py-3 pr-12 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-sm sm:text-base resize-none"
//             placeholder="Enter your message..."
//             rows={3}
//           />

//           {/* Delete Button — small and at right corner */}
//           <button
//             onClick={() => handleDeleteMessage(key)}
//             className="absolute top-[38px] right-3 bg-red-500 hover:bg-red-600 text-white p-2 rounded-lg shadow-sm transition-all duration-150"
...
/**
 * Admin.js
 * - Preserves your original logic and Firebase interactions verbatim
 * - Adds responsive layout:
 *    • Table view on md+ screens
 *    • Card list on mobile (no horizontal scroll)
 * - Makes modals scrollable with sticky action bars
 * - Keeps all handlers and message scheduling logic unchanged
 *
 * Copy-paste this file to replace your existing Admin.js
 */
